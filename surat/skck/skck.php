...
if ($_SESSION['login'] == "") {
	...
	if (isset($_POST['submit'])) {
		...
		$tglnew = date("d-m-Y", strtotime($tl));

		$docx = new DOCXTemplate('skck_blank.docx');
		...
		$docx->set('rt', $rt);
		$docx->set('tglsurat', $tglrilis);
		$docx->set('ttd1',$ttd1);
		$docx->set('ttd2',$ttd2);
		$docx->set('ttd3',$ttd3);
		$docx->set('ttd4',$ttd4);

		$docx->saveAs($nosurat.'_SKCK.docx');
		shell_exec($nosurat.'_SKCK.docx');
	}
		...
		<div id="content">
			<nav class="navbar navbar-expand navbar-light bg-light">
				<div class="container-fluid">
					...
					<h2>Surat Ket. Catatan Kepolisian</h2>
				</div>
			</nav>
			...
			<p>Desa Sungai Gampa 
				<select class="form-group" name="rt">
		 class="col-md-2 control-label"			<optgroup>
						<option>RT   </option>
			...
			Kecamatan Rantau Badauh Kabupaten Barito Kuala</p>
			<div>
